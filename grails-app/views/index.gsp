...
<html>
	...
	<body>
		...
		<div id="status" role="complementary">
			<h1>Acciones</h1>
			<ul>
				<li> <a href="${createLink(controller: 'ControladorPersona', action: 'index')}" >Ingresar persona</a></li>
				<li> <a href="${createLink(controller: 'ControladorPersona', action: 'personaLeer')}" >Leer persona</a></li>
				<li> <a href="${createLink(controller: 'ControladorPersona', action: 'personaBorrar')}" >Borrar persona</a></li>
				<li> <a href="${createLink(controller: 'ControladorPersona', action: 'personaActualizar')}" >Actualizar persona</a></li>
				...
				<li><a href="${createLink(controller: 'ControladorPersona', action: 'personaLeer')} ">Texto </a></li>
